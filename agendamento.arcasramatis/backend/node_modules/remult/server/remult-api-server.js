...
var remult_admin_js_1 = tslib_1.__importStar(require("./remult-admin.js"));
            ...
            if (this.options.admin !== undefined && this.options.admin !== false) {
                var admin = function () {
                    return _this.process(function (remult, req, res, orig, origResponse) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                        var allowed, head, requireAuthToken, disableLiveQuery;
                        ...
                        return tslib_1.__generator(this, function (_h) {
                            ...
                            if (remult.isAllowed(allowed)) {
                                if (((_a = orig === null || orig === void 0 ? void 0 : orig.params) === null || _a === void 0 ? void 0 : _a.id) === '__entities-metadata') {

...
var RepositoryImplementation = /** @class */ (function () {
    ...
    RepositoryImplementation.prototype.insert = function (entity) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var refs_1, raw, entity_1, entity_1_1, item, ref, _a, _b, e_6_1, _c, r, entity_2, entity_2_1, item, _d, _e, e_7_1, ref;
            var e_6, _f, e_7, _g;
            return tslib_1.__generator(this, function (_h) {
                switch (_h.label) {
                    case 0:
                    ...
                    case 25:
                        ...
                        return [4 /*yield*/, this.getEntityRef(this.create(entity)).save()];
    ...
    RepositoryImplementation.prototype.updateMany = function (_a) {
        return tslib_1.__awaiter(this, arguments, void 0, function (_b) {
            var _c, _d, updated, _e, _f, _g, item, e_10_1;
            var _h, e_10, _j, _k;
            ...
            return tslib_1.__generator(this, function (_l) {
                switch (_l.label) {
                    ...
                    case 1: return [2 /*return*/, _d.apply(_c, [_l.sent(), this.__createDto(tslib_1.__assign({}, set))])];
                    case 2:
                        updated = 0;
                        _l.label = 3;
                    case 3:
                        _l.trys.push([3, 9, 10, 15]);
                        _e = true, _f = tslib_1.__asyncValues(this.query({ where: where, aggregate: undefined }));
                        _l.label = 4;
            ...
            if (rel)
                if (incl) {
                    ...
                    var _loop_2 = function (row) {
                        var _e = this_1._findOptionsBasedOnRelation(rel, col, incl, row, otherRepo), findOptions = _e.findOptions, returnNull = _e.returnNull;
                        var colKey = col.key;
                        if (returnNull)
                            row[colKey] = null;
                        else {
    ...
    RepositoryImplementation.prototype.deleteMany = function (_a) {
        return tslib_1.__awaiter(this, arguments, void 0, function (_b) {
            var _c, _d, deleted, _e, _f, _g, item, e_22_1;
            var _h, e_22, _j, _k;
            var where = _b.where;
            return tslib_1.__generator(this, function (_l) {
                switch (_l.label) {
            ...
            return tslib_1.__generator(this, function (_t) {
                switch (_t.label) {
                    ...
                    case 22:
                        ...
                        return [4 /*yield*/, this.edp.update(this.id, changesOnly)];
                    case 23:
                        updatedRow = _t.sent();
                        _t.label = 24;
                    case 24:

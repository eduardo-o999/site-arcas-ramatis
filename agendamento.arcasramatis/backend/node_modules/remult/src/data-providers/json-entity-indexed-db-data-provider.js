...
var JsonEntityIndexedDbStorage = /** @class */ (function () {
    ...
    JsonEntityIndexedDbStorage.prototype.removeItem = function (entityDbName) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                        ...
                        return tslib_1.__generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    transaction = (_a.sent()).transaction([this.storeName], 'readwrite');
                                    store = transaction.objectStore(this.storeName);
                                    request = store.delete(entityDbName);
                                    request.onerror = function (_event) { return reject(request.error); };
                                    request.onsuccess = function (_event) { return resolve(); };
                                    return [2 /*return*/];
                            }
                        });
                    }); })];
